...
const LoginPage = () => {
  ...
  try {
    ...
    if (loginData.needsPasswordChange === 'true') {
      ...
      const userRole = loginData.user?.role || loginData.role;
      ...
      router.push(`${dashboardPath}?email=${encodeURIComponent(email)}`);
    }
  } catch (err: unknown) {
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="text-sm text-[#FBB906] font-medium hover:underline disabled:opacity-50"
                  disabled={isLoading}
                >
                  Forgot Password?
                </button>
        ...
        <div className="pt-12 pb-8 px-6 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Sign in</h1>
            <p className="text-gray-500 text-sm">
              ...
              <span className="text-[#FBB906] font-medium">Contact Admin</span>
            </p>
        </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 mb-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={togglePasswordVisibility}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#FBB906]"
                    disabled={isLoading}
                  >
                    {showPassword ? <EyeOff size={20} /> : <Eye size={20} />}
                  </button>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-purple-500 to-[#FBB906] text-white py-4 rounded-xl font-medium text-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 disabled:opacity-50 flex items-center justify-center mt-6"
              >
                {isLoading ? (
                  <>
                    <Loader2 className="animate-spin mr-2" size={20} />
