      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Repairs Today</p>
              <p className="text-2xl text-gray-700 font-bold">2</p>
            </div>
            <span className="bg-pink-100 text-pink-700 text-xs px-2 py-1 rounded">Active</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            ...
            <div className="w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center text-xs">2</div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Awaiting Parts</p>
              <p className="text-2xl text-gray-700 font-bold">1</p>
            </div>
