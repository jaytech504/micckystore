      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-pink-400 text-white text-xs px-2 py-1 rounded">Awaiting approval</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl text-gray-700 font-bold">3</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-pink-400 text-white text-xs px-2 py-1 rounded">ready to use</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl text-gray-700 font-bold">NGN320K</p>
            </div>
            <span className="bg-pink-400 text-white text-xs px-2 py-1 rounded">parts cost</span>
          </div>
        </div>
      </div>
