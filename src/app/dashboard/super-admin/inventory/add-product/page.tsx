  ...
  const handleSave = async () => {
    try {
      ...
      setFormData({
        ...
        setTimeout(() => {
      window.location.href = '/dashboard/super-admin/inventory';
        }, 2000);
      }
    } catch (err: any) {
      ...
      <div className="space-y-6">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Add New Product</h1>
              <p className="text-gray-600 text-sm">Add a new product to the inventory system.</p>
            </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            <Link
              ...
              className="bg-gray-500 text-white px-4 py-2.5 rounded-lg font-medium text-sm flex items-center justify-center gap-2 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
            >
              ← Back to Inventory
            </Link>
