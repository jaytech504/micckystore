    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          {/* Form Title */}
          <h2 className="text-xl font-semibold text-gray-900 mb-6">New Invoice</h2>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-16 py-2 text-gray-600 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E866B7] focus:border-transparent"
          ...
          <div className="mb-6">
            ...
            <button
              onClick={addNewItem}
              className="mt-4 px-4 py-2 bg-[#E866B7] hover:bg-pink-600 transition-colors flex items-center gap-2 rounded-lg"
            >
          ...
          <div className="flex gap-3 mb-6">
            <button className="px-6 py-2 bg-[#E866B7] text-white rounded-lg hover:bg-pink-600 transition-colors flex items-center gap-2">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-700">{formData.emailRecipient}</span>
              <button className="px-4 py-2 bg-[#E866B7] text-white rounded-lg hover:bg-pink-600 transition-colors text-sm flex items-center gap-2">
