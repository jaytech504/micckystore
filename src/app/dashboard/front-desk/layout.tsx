...
export default function SalesLayout({ children }: SalesLayoutProps) {
  ...
  const mainNavigationItems: NavigationItem[] = [
    { name: 'Dashboard', href: '/dashboard/front-desk', icon: LayoutDashboard },
    { name: 'Sales', href: '/dashboard/front-desk/sales', icon: ChartNoAxesCombined },
    { name: 'Inventory', href: '/dashboard/front-desk/inventory', icon: Calculator },
  ]
  ...
  const bottomItems: NavigationItem[] = [
    { name: 'Settings', href: '/dashboard/front-desk/settings', icon: Settings },
    { name: 'Contact Admin', href: '/dashboard/front-desk/contact-admin', icon: Users },
    { name: 'Log Out', href: '/dashboard/front-desk/logout', icon: LogOut }
  ]
